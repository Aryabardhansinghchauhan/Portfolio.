    ...
    return (
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a href="">
                    <img src="./assets/img.png" alt="Logo" className="cursor-pointer w-28 mr-14 dark:hidden" />
                    <img src="./assets/image.jpg" alt="Logo" className="hidden cursor-pointer w-28 mr-14 dark:block" />
                </a>

                <ul ref={navLinkRef} className="items-center hidden gap-6 px-12 py-3 bg-white bg-opacity-50 rounded-full shadow-sm md:flex lg:gap-8 font-Ovo dark:border dark:border-white/30 dark:bg-transparent ">
                ...
                {/* -- ----- mobile menu ------  -- */}
                <ul ref={sideMenuRef} className="fixed top-0 bottom-0 z-50 flex flex-col w-64 h-screen gap-4 px-10 py-20 transition duration-500 md:hidden -right-64 bg-rose-50 font-Ovo dark:bg-darkHover dark:text-white">
